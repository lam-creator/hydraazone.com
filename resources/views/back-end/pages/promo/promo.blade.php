...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'All Promo List')
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex">
                    <h5 class="box-title mr-auto p-2 mb-0">Promo</h5>
                    <button type="button" class="btn btn-primary btn-sm DataAddButton">Add Promo</button>
                </div>
                <div class="card-body">
...
<div class="modal fade" id="DataAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form id="DataAddUpdate" action="{{ route('admin.promo.insert') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        <label for="exampleInputTitle">Promo Title </label>
                                        <input class="form-control" type="text" name="title" placeholder="Promo title">
                                        @error('title')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        <label for="exampleInputSlogan">Promo Slogan </label>
                                        <input class="form-control" type="text" name="slogan" placeholder="Promo slogan">
                                        @error('slogan')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        <label for="exampleInputLink">Promo Link </label>
                                        <input class="form-control" type="text" name="link" placeholder="Promo link">
                                        @error('link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        <label for="exampleInputImage">Image <span class="text-danger">* Image size need to be 375x243</span></label>
...
<script>
    ...
    $('#dt-scroll-horizonal').DataTable({
        ...
        scrollX: true,
        ajax: {
            url: "{{ route('admin.promo.data') }}", // URL will change
            type: 'GET',
            cache: false,
            data: function(d) {
            }
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $(this).ajaxSubmit({
                    ...
                    , method: 'POST'
                    , dataType: 'json'
                    , url: "{{ route('admin.promo.insert') }}"  // URL will change
    ...
    $(document).on('click', '.tableEdit', function() {
        ...
        $(this).ajaxSubmit({
            ...
            , dataType: 'json'
            , method: 'GET'
            , url: "{{ route('admin.promo.edit') }}" // URL will change
            , success: function(responseText) {
