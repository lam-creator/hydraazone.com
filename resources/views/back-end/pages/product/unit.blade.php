...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'All Unit List')
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex">
                    <h5 class="box-title mr-auto p-2 mb-0">Unit</h5>
                    <button type="button" class="btn btn-primary btn-sm DataAddButton">Add Unit</button>
                </div>
                <div class="card-body">
...
<div class="modal fade" id="DataAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form id="DataAddUpdate" action="{{ route('admin.unit.insert') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        <label for="exampleInputName">Unit Name <span class="text-danger">*</span></label>
...
<script>
    ...
    $('#dt-scroll-horizonal').DataTable({
        ...
        scrollX: true,
        ajax: {
            url: "{{ route('admin.unit.data') }}",  // URL will change
            type: 'GET',
            cache: false,
            data: function(d) {
            }
        ...
        columns: [      // All columns will change
            ...
            {title: 'Slug', data: 'unit_slug', name: 'unit_slug'},
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $(this).ajaxSubmit({
                    ...
                    , method: 'POST'
                    , dataType: 'json'
                    , url: "{{ route('admin.unit.insert') }}"   // URL will change
    ...
    $(document).on('click', '.tableEdit', function() {
        ...
        $(this).ajaxSubmit({
            ...
            , dataType: 'json'
            , method: 'GET'
            , url: "{{ route('admin.unit.edit') }}"   // URL will change
            , success: function(responseText) {
