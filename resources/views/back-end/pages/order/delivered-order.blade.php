...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'All Delivered Order')
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex">
                    <h5 class="p-2 mb-0 mr-auto box-title">All Delivered Order</h5>
                </div>
                <div class="card-body">
...
$(function() {
    ...
    $('#dt-scroll-horizonal').DataTable({
        ...
        scrollX: true,
        ajax: {
            url: "{{ route('admin.delivered.orders.data') }}", // URL will change
            type: 'GET',
            cache: false,
            data: function(d) {}
        },
