...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'All Approved Order')
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex">
                    <h5 class="p-2 mb-0 mr-auto box-title">All Approved Order</h5>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="print-container" id="FullInvoiceContent">
                    ...
                    @media print {
                        ...
                        /* Optional: Remove buttons or modals during print */
                        .modal,
                        .btn,
                        .no-print {
                    ...
                    <h2 class="text-center">BD Dairy</h2>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary tableInvoiceWithNote" data-id="" >Print</button>
            </div>
        </div>
...
$(function() {
    ...
    $('#dt-scroll-horizonal').DataTable({
        ...
        scrollX: true,
        ajax: {
            url: "{{ route('admin.approved.orders.data') }}", // URL will change
            type: 'GET',
            cache: false,
            data: function(d) {}
        },
    ...
    $(document).on('click', '.tableDetails', function() {
        ...
        $(this).ajaxSubmit({
            ...
            success: function(responseText) {
                ...
                $('.tableInvoiceWithNote').data('id', order.id);
    ...
    // invoice code
    $(document).on('click', '.tableInvoice', function () {
        let id = $(this).data('id');

        let url = '/admin/invoice/' + id; // IMPORTANT: starts with /

        window.open(url, '_blank');
    });

    // print Invoice with Order Note
    $(document).on('click', '.tableInvoiceWithNote', function () {
        let id = $(this).data('id');

        let url = '/admin/delivery-man/invoice/' + id; // IMPORTANT: starts with /
